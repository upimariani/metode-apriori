		...
		<div class="row justify-content-between">
			...
			<div class="col-lg-7">
				<div class="hero-img-wrap">
					<img style="width: 750px;" src="<?= base_url('asset/a.jpg') ?>" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
...
<div class="why-choose-section">
	<div class="container">
		<div class="row justify-content-between">
			...
			<div class="col-lg-5">
				<div class="img-wrap">
					<img src="<?= base_url('asset/b.jpg') ?>" alt="Image" class="img-fluid">
				</div>
			</div>
			...
			?>
				...
				<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0 mt-5">
					<form action="<?= base_url('pelanggan/chome/cart') ?>" method="POST">
						...
						<input type="hidden" name="price" value="<?= $value->harga_jual ?>">
						...
						<a class="product-item" href="#">
							...
							<strong class="product-price">Rp. <?= number_format($value->harga_jual - ($value->potongan_harga / 100 * $value->harga_jual)) ?><?php if ($value->potongan_harga != NULL) {
																																							?>
								<del>Rp. <?= number_format($value->harga_jual, 0)  ?></del>
							<?php
																																							} ?></strong>
