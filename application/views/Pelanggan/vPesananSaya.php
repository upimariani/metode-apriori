				...
				<div class="site-blocks-table">
					<table class="table">
						...
						<tbody>
							...
							?>
								<tr>
									<td><strong><?= $value->id_order ?></strong></td>
									<td><?= $value->tgl ?></td>
									...
									<td class="text-center"><a href="<?= base_url('Pelanggan/cPesananSaya/detail_pesanan/' . $value->id_order) ?>"><i class="fa fa-bars" aria-hidden="true"></i></a></td>
								</tr>
