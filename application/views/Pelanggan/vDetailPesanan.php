						...
						<tbody>
							...
							?>
								<tr>
									...
									<td class="text-center">Rp. <?= number_format($value->harga_jual - ($value->harga_jual * $value->potongan_harga / 100))  ?></td>
									<td class="text-center">Rp. <?= number_format(($value->harga_jual - ($value->harga_jual * $value->potongan_harga / 100)) * $value->qty) ?></td>
								</tr>
							<?php
							}
							?>
			...
			<div class="col-md-6">
				...
				?>
					<div class="row">
						...
						<?php echo form_open_multipart('pelanggan/cPesananSaya/pembayaran/' . $detail['transaksi']->id_order); ?>
					...
					<div class="col-md-7">
						...
						<div class="row mb-5">
							...
							<div class="col-md-6 text-right">
								<strong class="text-black">Rp. <?= number_format($detail['transaksi']->total_bayar) ?></strong>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								?>
									...
									<a href="<?= base_url('pelanggan/cPesananSaya/diterima/' . $detail['transaksi']->id_order) ?>" class="btn btn-black">Konfirmasi</a>
