		...
		<div class="section-body">
			...
			<div class="text-md-right">
				<div class="float-lg-left mb-lg-0 mb-3">
					...
					?>
						<a href="<?= base_url('Marketing/cKonfirmasi/konfirmasi/' . $detail['transaksi']->id_order) ?>" class="btn btn-warning">Konfirmasi</a>
					<?php
					} else if ($detail['transaksi']->stat_order == '2') {
					?>
						<a href="<?= base_url('Marketing/cKirim/kirim/' . $detail['transaksi']->id_order) ?>" class="btn btn-info">Pesanan Dikirim</a>
