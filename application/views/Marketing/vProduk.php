										...
										?>
											<tr>
												...
												<td>
													...
													<a href="<?= base_url('Marketing/cProduk/delete/' . $value->id_produk) ?>" class="btn btn-danger"> Hapus </a>
												</td>
											</tr>
										<?php
										}
...
<div class="modal fade" tabindex="-1" role="dialog" id="exampleModal">
	<div class="modal-dialog" role="document">
		<?php echo form_open_multipart('marketing/cproduk/create'); ?>
...
?>
	<div class="modal fade" tabindex="-1" role="dialog" id="edit<?= $value->id_produk ?>">
		<div class="modal-dialog" role="document">
			<?php echo form_open_multipart('marketing/cproduk/update/' . $value->id_produk); ?>
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Masukkan Data Produk</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
