<div class="main-sidebar sidebar-style-2">
	<aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li <?php if ($this->uri->segment(1) == 'Marketing' && $this->uri->segment(2) == 'cDashboard') {
					echo 'class=active';
				}  ?>><a class="nav-link" href="<?= base_url('Marketing/cDashboard') ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
			...
			<li <?php if ($this->uri->segment(1) == 'Marketing' && $this->uri->segment(2) == 'cProduk') {
					echo 'class=active';
				}  ?>><a class="nav-link" href="<?= base_url('Marketing/cProduk') ?>"><i class="fas fa-store-alt"></i> <span>Data Produk</span></a></li>

			<li <?php if ($this->uri->segment(1) == 'Marketing' && $this->uri->segment(2) == 'cPromosi') {
					echo 'class=active';
				}  ?>><a class="nav-link" href="<?= base_url('Marketing/cPromosi') ?>"><i class="fas fa-percentage"></i> <span>Data Promosi</span></a></li>
